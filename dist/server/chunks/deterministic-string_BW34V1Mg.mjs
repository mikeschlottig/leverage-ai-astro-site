...
import { A as AstroError, N as NoImageMetadata, y as FailedToFetchRemoteImageDimensions, b as isRemoteAllowed, z as RemoteImageNotAllowed, B as joinPaths, E as ExpectedImage, i as isRemotePath, L as LocalImageUsedWrongly, M as MissingImageDimension, C as UnsupportedImageFormat, D as IncompatibleDescriptorOptions, G as UnsupportedImageConversion, H as ExpectedImageOptions, J as ExpectedNotESMImage, K as InvalidImageService } from "./worker-entry_D9jsJv2k.mjs";
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      "./image-service-workerd_DXkWlPXi.mjs"
    ).catch((e) => {
