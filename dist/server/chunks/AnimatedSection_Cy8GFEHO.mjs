...
import { j as jsxRuntimeExports } from "./createLucideIcon_DZRUm3Z8.mjs";
...
function AnimatedSection({ children, className = "", delay: delay2 = 0, style }) {
  const ref = reactExports.useRef(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      animate: inView2 ? { opacity: 1, y: 0 } : { opacity: 0, y: 32 },
      transition: { duration: 0.7, ease: [0.22, 1, 0.36, 1], delay: delay2 },
      children
    }
  );
}
