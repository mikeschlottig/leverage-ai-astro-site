...
// node_modules/@astrojs/react/dist/server.js
var import_react2 = __toESM(require_react());
var import_server = __toESM(require_server_edge());
import opts from "astro:react:opts";

// node_modules/@astrojs/react/dist/context.js
...
async function renderToStaticMarkup(Component, props, { default: children, ...slotted }, metadata) {
  ...
  if (children && opts.experimentalReactChildren) {
    ...
    const convert = await import("./vnode-children-R5FY3MPW.js").then((mod) => mod.default);
  ...
  if (opts.experimentalDisableStreaming) {
    html = import_server.default.renderToString(vnode);
  } else if ("renderToReadableStream" in import_server.default) {
...
react-dom/cjs/react-dom-server-legacy.browser.production.js:
   ...
   *)
*/
//# sourceMappingURL=@astrojs_react_server__js.js.map
